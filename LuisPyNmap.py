#!/usr/bin/env python
# -*- coding: utf-8 -*-
__author__ = "Luis Contreras"
__email__ = "quique@columbiabasin.edu"
__date_ = "Spring 2020"
__version__ = "0.0.1"
...
os.chdir('C:\\Users\\quique')

cwd = os.getcwd()
print(cwd)

# SET VARIABLES
my_dir = 'C:\\Users\\quique\\Downloads\\tmp'

#create the files so they start witht he date.
date_str = date.today().strftime("%m%d%y")
my_pickle = 'C:\\Users\\quique\\Downloads\\tmp\\%s.pickle' % date_str
my_json = 'C:\\Users\\quique\\Downloads\\tmp\\%s.json' % date_str
